...
\def\author{Vladar}
\def\license{Creative Commons Attribution-ShareAlike (CC BY-SA 4.0)}
\def\licenselink{https://creativecommons.org/licenses/by-sa/4.0/}
\def\rtVer{0.1}
...
\tabpar[6][6]{Nunc sed pede. Praesent vitae lectus. Praesent neque justo,
	...
	at purus et libero lacinia dictum. Fusce aliquet. Nulla eu
	ante placerat leo semper dictum. Mauris metus. Curabitur
	lobortis. Curabitur sollicitudin hendrerit nunc.}
